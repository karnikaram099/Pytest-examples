...
function filterTable(elem) { // eslint-disable-line no-unused-vars
    ...
    <h1>test_google_test.py</h1>
    <p>Report generated on 27-Jul-2022 at 15:22:09 by <a href="https://pypi.python.org/pypi/pytest-html">pytest-html</a> v3.1.1</p>
    <h2>Environment</h2>
    ...
    <h2>Summary</h2>
    <p>0 tests ran in 0.27 seconds. </p>
    ...
    <table id="results-table">
      ...
      <tbody class="error results-table-row">
        <tr>
          ...
          <td class="col-name">test_google_test.py::collect</td>
